...
pi-herdr 对 Pi 只暴露 `Agent`、`ListAgents` 和 `SendMessage`，不包装通用 workspace、tab、pane、layout、terminal input、agent wait/focus、worktree cleanup、plugin/server/integration 或 notification 管理能力。
